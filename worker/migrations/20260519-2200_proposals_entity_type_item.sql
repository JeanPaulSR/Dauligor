-- Phase 4 — add `item` to `pending_revisions.entity_type` allowlist
-- ============================================================
-- Same SQLite "can't ALTER a CHECK in place" rebuild as the subclass
-- + feat migrations. ItemsEditor (via DevelopmentCompendiumManager)
-- now submits drafts through the proposal pipeline.
