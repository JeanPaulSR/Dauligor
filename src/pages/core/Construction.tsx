...
export default function Construction() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-8 max-w-2xl mx-auto px-4">
      <div className="w-24 h-24 bg-gold/15 rounded-full flex items-center justify-center border border-gold/35">
      ...
      <div className="space-y-4">
        ...
        <p className="text-lg text-ink/65 font-medium">
      ...
      <div className="pt-8 flex flex-col items-center gap-4">
        <div className="p-4 bg-card border border-gold/15 rounded-lg shadow-sm w-full italic text-ink/45 text-sm">
        ...
        <Button 
          variant="outline" 
          onClick={() => navigate(-1)}
          className="border-gold/35 text-gold hover:bg-gold/5 gap-2"
        >
