            ...
            <div className="prose prose-gold prose-sm max-w-none">
              {loadingFeatures[selectedItem?.featureId] ? (
                <div className="animate-pulse flex space-y-4 flex-col">
                  <div className="h-4 bg-gold/15 rounded w-3/4"></div>
                  <div className="h-4 bg-gold/15 rounded"></div>
                  <div className="h-4 bg-gold/15 rounded w-5/6"></div>
                </div>
              ) : (
                <>
                                    ...
                                    <div className="animate-in fade-in slide-in-from-top-2 duration-300 bg-gold/5 border border-gold/25 rounded p-4">
                                      ...
                                      <div className="flex flex-wrap gap-2">
                                        {adv.configuration?.choiceType === 'option-group' ? (
                                          <span className="px-2 py-1 bg-background/50 border border-gold/15 border-dashed rounded text-[11px] font-medium text-ink/65">
