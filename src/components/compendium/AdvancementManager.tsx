...
export default function AdvancementManager({
  ...
  const handleSave = () => {
    ...
    onChange(next);
    // Advancements live on the parent class / subclass / feature row
    // and don't actually persist until the parent is saved. Toast says
    // "updated" rather than "saved" so the wording doesn't misrepresent
    // commit state.
