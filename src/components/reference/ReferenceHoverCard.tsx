        ...
        if (c.variant === 'prereq') {
          return (
            <div
              ...
              data-hc-card=""
              data-hc-depth={d}
              className="fixed w-[260px] rounded-md border border-gold/35 bg-card shadow-xl shadow-black/40 px-3 py-2"
              style={style}
              onMouseEnter={cancelHide}
              onMouseLeave={scheduleReap}
            >
              <div className="text-[10px] uppercase tracking-wide text-gold/75 mb-1">Full prerequisite</div>
              <div className="text-xs text-ink/95">{c.prereqText}</div>
            </div>
          );
        }
