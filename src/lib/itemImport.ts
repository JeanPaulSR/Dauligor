...
// `foundryActivityToSemantic` now lives in the shared `./foundryActivities`
// module (imported above), so the feat + spell importers reuse the exact
// same converter. See that file for the Foundry-vs-semantic rationale.
